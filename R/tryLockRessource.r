...
#' @seealso \code{
#'    \link[rapp.core.filesys]{tryLockRessource-character-method}
#' }
#' @template author
#' @template references
#' @export 
...
#' 
#' @description 
#' See generic: \code{\link[rapp.core.filesys]{tryLockRessource}}
#' 
...
#' @example inst/examples/tryLockRessource.r
#' @seealso \code{
#'    \link[rapp.core.filesys]{tryLockRessource}
#' }
#' @template author
#' @template references
#' @export 
